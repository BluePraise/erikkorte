        ...
        <ul class="list-unstyled d-flex align-items-center justify-content-center gap-3 mb-0">
            <?php if (get_field('Address', 'option')): ?>
                <li class="d-inline-flex align-items-center">
                    <i class="las la-map-marker-alt me-2" aria-hidden="true"></i>
            ...
            <?php if (get_field('phone_number', 'option')): ?>
                <li class="d-inline-flex align-items-center">
                    <i class="las la-phone me-2" aria-hidden="true"></i>
            ...
            <?php if (get_field('email_address', 'option')): ?>
                <li class="d-inline-flex align-items-center">
                    <i class="lar la-envelope me-2" aria-hidden="true"></i>
            ...
            <?php if (get_field('facebook_url', 'option')): ?>
                <li class="d-inline-flex align-items-center">
                    <i class="lab la-facebook-f me-2" aria-hidden="true"></i>
